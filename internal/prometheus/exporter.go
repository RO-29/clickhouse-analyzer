...
var knownMetrics = map[string][]string{
	...
	// Parts & merges
	"tables_parts_count":             {"database", "disk", "table"},
	...
	"mvs_chained_count":              {},
	"mvs_failures":                   {"target", "view"},
	"mvs_timing_executions":          {"target", "view"},
	"mvs_timing_avg_ms":              {"target", "view"},
	"mvs_timing_max_ms":              {"target", "view"},
	"mvs_timing_p95_ms":              {"target", "view"},
	"mvs_target_bytes":               {"target", "view"},
	"mvs_target_rows":                {"target", "view"},
	// Cache
